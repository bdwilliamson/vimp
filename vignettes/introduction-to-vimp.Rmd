...
This code takes approximately 5 seconds to run on a (not very fast) PC. I can display these estimates:
...
obe_vim <- vimp_rsquared(Y = heart$chd, X = x, indx = 5, SL.library = learners.2, na.rm = TRUE, env = environment(), V = V, cvControl = sl_cvcontrol)
