...
#' in the usual \code{lm} format.
#' @param dat the dataset. Must be in \eqn{n x (p+1)}, where the last
#' column is \eqn{Y}.
...
#' @param type the nonparametric estimation tool to use, defaults to
#' \code{mgcv}. Partial strings can be used, if they are unique identifiers of the tool.
