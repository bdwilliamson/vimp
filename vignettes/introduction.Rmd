...
lst.vim <- list(crim.vim, zn.vim, indus.vim, chas.vim, nox.vim, rm.vim, age.vim, dis.vim, rad.vim, tax.vim, ptratio.vim, black.vim, lstat.vim)

## make the class of the list npvi, for plot to work correctly
tmp.cls <- class(lst.vim)
tmp.cls <- c("npvi", tmp.cls)
class(lst.vim) <- tmp.cls

## create a vector of names
nms <- c("Crime", "Prop. large zoned", "Prop. business", "Charles riv.", "Nitrogen oxide", "Avg. num. rooms", "Age", "Distance", "Acces to radial hwys", "Property tax rate", "Pupil-teacher ratio", "Prop. black", "Prop. lower status")

## plot
plot(lst.vim, nms, pch = 16, ylab = "", xlab = "Estimate", main = "Estimated variable importance", xlim = c(0, 0.2), axes = FALSE)
```
