...
#' Manuscripts:
#' \itemize{
#'   \item{\url{https://doi.org/10.1111/biom.13392} (R-squared-based variable importance)}
#'   \item{\url{https://doi.org/10.1111/biom.13389} (Rejoinder to discussion on R-squared-based variable importance article)}
